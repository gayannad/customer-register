    ...
    <app-layout title="Dashboard">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-5">
            ...
            <div class="p-4">
                ...
                <input type="text" v-model="search" @keyup="search" class="ml-2 px-2 py-1 text-sm rounded border">
            </div>
            <table class="w-full">
...
<script>
    ...
    export default defineComponent({
        ...
        methods:
            {
                search() {
                    this.$inertia.replace(this.$route('customers.index', {search: this.search}))
                }
            }
    })
</script>
